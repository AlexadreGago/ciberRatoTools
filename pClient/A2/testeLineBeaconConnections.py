...
v1.connects["down"] = v2.id
v1.connects["left"] = v0.id
v2.connects["up"] = v1.id
v2.connects["right"] = v3.id
v3.connects["left"] = v2.id
v3.connects["up"] = v5.id
v3.connects["right"] = v4.id
v4.connects["left"] = v3.id
v5.connects["down"] = v3.id
...
vertexList = [v0,v1,v2,v3,v4,v5]

b1 = Beacon(2,0, id=1,direction = "right",vertexList=vertexList)
b3 = Beacon(4,-2, id=3,direction = "down",vertexList=vertexList)
b4 = Beacon(8,-4, id=4,direction = "down",vertexList=vertexList)
