...
class MyRob(CRobLinkAngs):
    ...
    def wander(self):
        ...
        #########################################
            ...
            if(self.measures.lineSensor[0]=="1"or self.measures.lineSensor[6]=="1") and not rotate:
                #CHECK IF NEAR A CREATED VERTEX AND IF DOESNT EXIST DOENS'T CREATEANEW VERTEX:
